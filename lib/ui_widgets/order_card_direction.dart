          ...
          Expanded(
            child: Container(
              child: orderModel.orderType == 2 ? Column(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text(orderModel.isSpareOrder == true ? 'pickupFromShop'.tr : 'pickupF'.tr, style: TextStyle(fontWeight: FontWeight.bold)),
                  Text(orderModel.fromFullAddress ?? '', style: TextStyle(color: Colors.grey)),
                  SizedBox(height: 15.0),
                  Text('dropAt'.tr, style: TextStyle(fontWeight: FontWeight.bold)),
