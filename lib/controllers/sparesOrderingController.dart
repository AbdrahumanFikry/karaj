  ...
  Future<SparesModel> submitOrder({UserModel shop}) async {
    if(FirebaseAuth.instance.currentUser != null) {
      try {
        ...
        if(shop.personalData.containsKey("addressData")) {
          o.shopAddress = shop.personalData["addressData"]["address"] ?? null;
          o.shopAddressData = shop.personalData["addressData"];
        }

        if(shop.personalData["companyName"] != null) {
          o.shopName = shop.personalData["companyName"];
        } else if(shop.personalData["commercialName"] != null) {
