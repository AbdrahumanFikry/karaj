...
class OrderModel {
  ...
  factory OrderModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return OrderModel(
      ...
      fromFloorPrice: json["fromFloorPrice"] ?? 0,
      toFloorPrice: json["toFloorPrice"] ?? 0,
      ...
      date: getOrderDate(json['timestamp']),
      dates: json["dates"] ?? {},
      rated: json["rated"] ?? false,
      stars: json["stars"] ?? 0,
      clientRated: json["clientRated"] ?? false,
      canBeReRequest: json["canBeReRequest"] ?? true,
      ...
      timestamp: json["end_at"].toString() ?? '',
    );
  }
  ...
  Map<String, dynamic> toMap() => {
    ...
    "fromFloor": fromFloor,
    "toFloor": toFloor,
    "fromFloorPrice": fromFloorPrice,
    "toFloorPrice": toFloorPrice,
    "payCash": payCash,
    "payed": payed,
    "paymentId": paymentId,
    "status": status,
    ...
    "canBeReRequest": canBeReRequest ?? true,
