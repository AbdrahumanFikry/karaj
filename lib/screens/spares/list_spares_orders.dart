...
class ListSparesOrdersWidget extends StatelessWidget {
  ...
  const ListSparesOrdersWidget(
      {Key key, this.orders, this.displayScroll = false})
      : super(key: key);
  @override
                ...
                children: [
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        FirebaseAuth.instance.currentUser?.uid == order.shopId
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('clientName'.tr,
                        ...
                        Text('spares'.tr,
                            style: TextStyle(
                                fontSize: 11.0, color: Color(0xFF949597))),
                        Text(spares),
                      ],
                    ),
                  ),
                  Flexible(
                    child: Column(
                      children: [
                        ...
                        Text(orderSpareStatus(order.status),
