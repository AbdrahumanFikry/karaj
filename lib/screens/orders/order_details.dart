          ...
          builder: (context, snapshot) {
            if(snapshot.hasData) {
              ...
              if(x.exists) {
                ...
                return isDriver && status >= 3 && orderSnap.driverId != FirebaseAuth.instance.currentUser?.uid ? Center(child: Text('noOrdersToDisplay'.tr),): SingleChildScrollView(
                  ...
                  child: Column(
                    children: <Widget>[
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                Text('estimatedTime'.tr, style: TextStyle(fontSize: 13.0, color: Colors.grey))
                              ],
                            ),
                            Column(
                              children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text('amount'.tr, style: TextStyle(fontSize: 13.0, color: Colors.grey))
                              ],
                            ),
                          ],
                        ),
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    child: ClipRRect(
                                      ...
                                      child: Container(
                                        ...
                                        child: orderSnap.driverAvatar == null || orderSnap.driverAvatar.length <= 7 ? const SizedBox.shrink() : Image(
                                  ...
                                  Container(
                                    child: Column(
                                      children: [
                                        orderSnap.carFrontImage == null || orderSnap.carFrontImage.length <= 7 ? const SizedBox.shrink() : Image(
                      ...
                      Container(
                        ...
                        child: Stack(
                          children: [
                            Positioned(
                              top: 0,
                              right: Get.locale.languageCode == 'en' ? null : MediaQuery.of(context).size.width * 0.1,
                              left: Get.locale.languageCode != 'en' ? null : MediaQuery.of(context).size.width * 0.1,
                              child: Container(
                      ...
                      paymentListDetails('vehicleType'.tr, orderSnap.vehicleType == 1 ? 'van'.tr : 'pickup'.tr),
                      ...
                      status > 1 ? Column(
                        children: [
                          ...
                          orderSnap.orderType == 2 ? Column(
                            children: [
                              paymentListDetails(orderSnap.fromFloorString ?? '', "${orderSnap.fromFloorPrice}  ${"sar".tr}" ?? ''),
                              paymentListDetails(orderSnap.toFloorString ?? '', "${orderSnap.toFloorPrice}  ${"sar".tr}" ?? ''),
                            ],
                          ) : SizedBox.shrink(),
                          Divider(),
                      ...
                      controller.user?.id == orderSnap.userId && status == 97 ? normalFlatButtonWidget(
                          colour: Colors.transparent,
                          textColor: Get.theme.errorColor,
                          context: context,
                          text: 'btnReRequestDriver'.tr,
                          callFunction: () async {
                            await Database().setOrderStatus(status: 1, orderID: orderSnap.id, order: orderSnap);
                          }
                      ) : SizedBox.shrink(),
        ...
        children: [
          Container(
            ...
            margin: EdgeInsets.only(
                right: Get.locale.languageCode == 'en' ? 0 : MediaQuery.of(context).size.width * 0.1 - (15/2),
                left: Get.locale.languageCode != 'en' ? 0 : MediaQuery.of(context).size.width * 0.1 - (15/2),
                top: 15.0),
            decoration: BoxDecoration(
