...
class ShopProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String name = shop?.personalData["companyName"] ??
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    Helpers.launchMap(
                        lat: shop.personalData["addressData"]["lat"],
                        lng: shop.personalData["addressData"]["lng"]);
                  },
                  child: Text(
                      shop.fullAddress ??
                          shop.personalData["addressData"]["address"] ??
                          "",
