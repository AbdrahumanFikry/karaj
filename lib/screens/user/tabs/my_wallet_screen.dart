    ...
    return WrapTextOptions(
      child: SafeArea(
        child: Scaffold(
          appBar: appBar(
              title: '',
              clr: Get.theme.primaryColor,
              iconClr: Get.theme.backgroundColor),
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: WalletEarnCard(
                                      amount:
                                          Helpers.fixPrice(_user.totalBalance),
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      ...
                                      if (record["paymentType"] == "order") {
                                        Get.to(OrderDetails(
                                            orderIDX: record["forId"]));
                                      } else if (record["paymentType"] ==
                                              "spares" ||
                                          record["paymentType"] == "spare") {
                                        RoutingSwitch.routeToSpareOrder(
                                            id: record["forId"]);
                                      }
                                    },
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: ListTile(
                                            title: Text(
                                                "${'${record['type_title']}'.tr} ${record["forId"]}"),
                                            subtitle: Text(
                                              record["date"] ?? "",
                                            ...
                                            trailing: Text(
                                              "${Helpers.fixPrice(record["totalAmount"])} ${"sar".tr}" ??
                                                  "",
                                              style: TextStyle(
                                                  color: !added
...
class WalletEarnCard extends StatelessWidget {
  ...
  const WalletEarnCard(
      {Key key, this.amount, this.text, this.clr, this.checkAmount = false})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
