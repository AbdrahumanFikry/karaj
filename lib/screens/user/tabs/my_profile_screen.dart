...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  Future<void> _fetchUser() async {
    ...
    avatar = _user.avatar ?? _user.personalData['AvatarPath'] ?? null;
    setState(() {
      onLoading = false;
    });
  }
                    ...
                    children: [
                      ...
                      ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: imagePath != null ? Image.file(imagePath, width: 114.0, fit: BoxFit.cover) : avatar != null ? Image.network(avatar, width: 114.0, fit: BoxFit.cover) : SizedBox.shrink(),
                        ),
                      )
                          : circleAvatarNetwork(
                          src: _user.avatar,
