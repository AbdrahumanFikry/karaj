...
class BottomWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.menu_outlined), label: 'myOrders'.tr,),
          BottomNavigationBarItem(icon: Icon(Icons.restore), label: 'myPayments'.tr),
          BottomNavigationBarItem(icon: Icon(Icons.person_pin), label: 'myAccount'.tr),
        ],
      ),
    );
  }
